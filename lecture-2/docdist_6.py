...
# Changed insertion sort to merge sort
...
def count_frequency(word_list):
    ...
    return merge_sort(returned_list)
...
def merge_sort(A):
    ...
    LHS = merge_sort(A[:mid])
    RHS = merge_sort(A[mid:])

    return merge(LHS,RHS)

def merge(L, R):

    # this function sorts and merges passed L & R
    i = 0
    j = 0
    result = []
...
if __name__ == "__main__":
    ...
    # Calculates document distance between bobsey & lewis in approx 0.47
    print(end - start)
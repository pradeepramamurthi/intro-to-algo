...
# Improve timing by changing + between 2 lists to extend in get_words_from_line_list().
# Instead of O(L1 + L2) for + operator  it becomes O(L1) by using extend.
#
...
if __name__ == "__main__":
    ...
    # Calculates document distance between bobsey & lewis in approx 37.70
    print(end - start)